<?php
  ...
  if(isset($_POST["filesave"])) titulo('(TF1) '.htmlspecialchars($_POST["filesave"]));
  else titulo('(TF1)');
  ...
  echo '<div id="topo">
        <h1> <a href="../">webROOT</a> (TF1) - fun&ccedil;&atilde;o de uma vari&aacute;vel em x </h1>
        <hr>
        </div>
        ...
        <div id="commands"> 
	     ...
	     <center>'
	    .aplicacao($_POST).'<br>'
	    .funcao_teorica($_POST,false,false,true).'<br>'
        .eixos($_POST)
